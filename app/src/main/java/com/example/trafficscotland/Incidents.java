...
public class Incidents extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(Incidents.this, roadmap.class);
                Incidents.this.startActivity(myIntent);
            }
        });
    ...
    private class Task implements Runnable
    {
        ...
        public void run()
        {
            ...
            Incidents.this.runOnUiThread(new Runnable()
            {
                public void run() {
                    ...
                    try {
                        ...
                        while (event!= XmlPullParser.END_DOCUMENT){
                            ...
                            switch (event) {
                                ...
                                case XmlPullParser.END_TAG:
                                    switch (tag) {
                                        case "title": item.put("title",text);
                                            break;
                                        case "description":

                                            item.put("description",text);
                                            break;
                                        case "pubDate": item.put("pubDate",text);
                                            break;
                                        case "item":
                                            if(item!=null)
                                                userList.add(item);
                        ...
                        ListAdapter adapter = new SimpleAdapter(Incidents.this, userList, R.layout.row,
